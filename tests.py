...
class TestReverse(unittest.TestCase):
    ...
    def test_wordn(self):
        ...
        self.assertEqual(reverse('12 345 543 21', False, 1, True, 2), '21 543 345 12')
        self.assertEqual(reverse('12 34 5195 43 21', False, 1, True, 2), '21 43 5195 34 12')
    ...
    def test_character_wordnn(self):
        ...
        self.assertEqual(reverse('abcd defg ghij klmn', True, 2, True, 2), 'edgf badc hgji lknm')
        self.assertEqual(reverse('abc d efgh ij k lmnop qrstuv', True, 2, True, 3), 'gfeh d bac mlonp k ji rqtsvu')
        self.assertEqual(reverse('abc d efgh ij k lmnop qrstuv', True, 3, True, 2), 'd cba gfeh ji nmlpo k srqvut')
        self.assertEqual(reverse(' abc\nd efgh ij k lmnop qrstuv', True, 3, True, 2), ' d\ncba gfeh ji nmlpo k srqvut')
        self.assertEqual(reverse('abc\td efgh ij k lmnop qrstuv\r \r', True, 3, True, 2), 'd\tcba gfeh ji nmlpo k srqvut\r \r')
